...
; (function ($) {
    ...
    $.fn.selectOrDie = function (method) {
        ...
        var $defaults = {
                ...
                customClass:       "extend-custom-select",        // String  - "" by default - Adds a class to the SoD
        ...
        var _private = {
            ...
            isTouch: function () {
                ...
                var isMobile = navigator.userAgent.match(/Android|iPhone|iPad|iPod|BlackBerry|Opera Mini|IEMobile/i);
                if (isMobile) return true;


                /* if galaxy note 10.1 
                if(navigator.userAgent.match(/SM-P600|SM-P601|SM-P605|SM-P605M|SM-P605S|GT-N8000|GT-N8005|SHW-M380S|SHW-M480W/i)) {
                    return true;
                }
                */
